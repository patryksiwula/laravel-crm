            ...
            <div class="w-full bg-white p-8 shadow-md">
                <form action="{{ route('meetings.store') }}" method="POST">
                    ...
                    <div class="block">
                        ...
                        <input type="text" placeholder="{{ __('Meeting description') }}" name="description" class="w-full border-[1.5px] border-form-stroke
					...
					<div class="mt-8">
                        ...
                        <input type="datetime-local" name="time" placeholder="{{ __('Meeting time') }}" class="w-full border-[1.5px] border-form-stroke
                            rounded-lg py-3 px-5 font-medium text-body-color placeholder-body-color outline-none focus:border-primary
                            active:border-primary transition disabled:bg-[#F5F7FD] disabled:cursor-default">
                    </div>
