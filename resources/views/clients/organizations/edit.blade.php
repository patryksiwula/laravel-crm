            ...
            <div class="w-full bg-white p-8 shadow-md">
                <form action="{{ route('organizations.update', ['organization' => $organization]) }}" method="POST">
                    ...
                    <div class="block">
                        ...
                        <input type="text" placeholder="{{ __('Organization name') }}" name="name" value="{{ $organization->name }}" class="w-full border-[1.5px]
                    ...
                    <div class="mt-8">
                        ...
                        <input type="email" placeholder="{{ __('Organization email') }}" name="email" value="{{ $organization->email }}" class="w-full border-[1.5px] border-form-stroke
                    ...
                    <div class="mt-8">
                        ...
                        <input type="text" placeholder="{{ __('Organization telephone') }}" name="phone" value="{{ $organization->phone }}" class="w-full
					...
					<div class="mt-8">
                        ...
                        <input type="text" placeholder="{{ __('Organization address') }}" name="address" value="{{ $organization->address }}" class="w-full
							border-[1.5px] border-form-stroke rounded-lg py-3 px-5 font-medium text-body-color placeholder-body-color outline-none
							focus:border-primary active:border-primary transition disabled:bg-[#F5F7FD] disabled:cursor-default">
                    </div>
					...
					<div class="mt-8">
                        ...
                        <input type="text" placeholder="{{ __('Organization VAT number') }}" name="vat" value="{{ $organization->vat }}" class="w-full
							border-[1.5px] border-form-stroke rounded-lg py-3 px-5 font-medium text-body-color placeholder-body-color outline-none
							focus:border-primary active:border-primary transition disabled:bg-[#F5F7FD] disabled:cursor-default">
                    </div>
