<div>
	...
	<select name="clientType" id="client_type" wire:model="clientType" wire:change="setClientType" class="w-full border-[1.5px] border-form-stroke rounded-lg py-3 px-5 font-medium
