<form wire:submit.prevent="save" class="mt-3">
	...
	<div class="mt-8">
		...
		<input type="date" wire:model="invoice_date" wire:change="generateInvoiceNumber" name="invoice_date" class="w-full border-[1.5px] border-form-stroke
			rounded-lg py-3 px-5 font-medium text-body-color placeholder-body-color outline-none focus:border-primary
			active:border-primary transition disabled:bg-[#F5F7FD] disabled:cursor-default">
	</div>
	...
	<div class="mt-8">
		...
		<input type="date" wire:model="sale_date" name="sale_date" class="w-full border-[1.5px] border-form-stroke
			rounded-lg py-3 px-5 font-medium text-body-color placeholder-body-color outline-none focus:border-primary
			active:border-primary transition disabled:bg-[#F5F7FD] disabled:cursor-default">
	</div>
	...
	<div class="mt-8">
		...
		<input type="date" wire:model="due_date" name="due_date" class="w-full border-[1.5px] border-form-stroke
			rounded-lg py-3 px-5 font-medium text-body-color placeholder-body-color outline-none focus:border-primary
			active:border-primary transition disabled:bg-[#F5F7FD] disabled:cursor-default">
	</div>
	...
	<div class="mt-8 grid grid-cols-2">
		...
		<div class="pl-2">
			...
			text-body-color outline-none focus:border-primary active:border-primary transition disabled:bg-[#F5F7FD] disabled:cursor-default
			appearance-none">
				<option>{{ __('Select a client') }}</option>
